 ...
 * <p>
 * For AES 128 HMAC SHA-256 is used. For AES 256 HMAC SHA-512 is used.
 * <p>
...
public class AesKey {
  ...
  public enum KeySize {
    ...
    public byte[] newKey() {
      ...
      Aes256SecureRandom.nextBytes(bts);
    ...
    public ExpandedKey genKeysHmacSha(byte[] key) {
      ...
      byte[] authKey = HKDF.fromHmacSha256()
        .expand(key, AUTH_KEY_META, macSizeBts); //HMAC-SHA256 key is 32, HMAC-SHA512 key is 64 byte
