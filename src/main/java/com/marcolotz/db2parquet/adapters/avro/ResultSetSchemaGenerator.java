...
public class ResultSetSchemaGenerator {
   ...
   * @throws SQLException
   */
  public ParsedAvroSchema generateSchema(ResultSet resultSet, String name, String nameSpace)
    throws SQLException {
   ...
   * @return
   */
  public Schema.Field createNullableField(Schema recordSchema, String columnName,
    Schema.Type type) {
